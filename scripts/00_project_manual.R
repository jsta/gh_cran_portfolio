...
entries <- list(
  data.frame(name = "smwrQW", tile_tooltip = "Water quality USGS water science R functions.", 
             ...
             remote_img = "https://owi.usgs.gov/R/img/usgs-r-logo.png", bg_color = "#198CE7", 
             img = "static/logos/smwrQW.svg", stringsAsFactors = FALSE), 
  data.frame(name = "r-raster-vector-geospatial", 
             ...
             remote_img = NA, bg_color = "#198CE7", 
             img = "static/logos/r-raster-vector-geospatial.svg", stringsAsFactors = FALSE)
)
